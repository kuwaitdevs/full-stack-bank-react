            ...
            <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
                ...
                >
                    ...
                    <Nav.Item className="mx-3">
                        <Nav.Link onClick={() => navigate('/bank/transactions')} eventKey="/bank/transactions">
                            Transactions
                        </Nav.Link>
                    </Nav.Item>

                    <Nav.Item className="mx-3">
                        <Nav.Link onClick={() => navigate('/bank/users')} eventKey="/bank/users">
                            Users
                        </Nav.Link>
                    </Nav.Item>

                    <Nav.Item className="mx-3">
                        <Nav.Link onClick={() => navigate('/bank/profile')} eventKey="/bank/profile">
                            Profile
                        </Nav.Link>
                    </Nav.Item>
                </Nav>
